...
2. Upload *members-only* folder into your *wp-content/plugins/* directory
...
**0.7**
* *New Feature:* Added the option to make individual posts and pages *Members Only* with the ability to set the default protect for pages and posts.
* Added the ability to set the Post of Page protection from with the Write or Edit page.
* Added and icon to the Manage Posts and Manage Pages page to show whether the are protect or not.
* Rewritten how Page and Post protection.
* Improved settings page by hiding options that are not applicable.
...
You can choose to protect the either the whole site, or via a drop down menu, protect individual posts or pages (need to finish this...)
